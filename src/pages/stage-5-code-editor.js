...
import { Theme, Text, Section, Box, Image, Span, List, Icon, Button, Em, LinkBox } from "@quarkly/widgets";
	...
	return <Theme theme={theme}>
		...
		<Section padding="100px 0" sm-padding="40px 0 60px 0" md-padding="60px 0 80px 0" quarkly-title="What's Next?">
			...
			<Text
				...
				lg-width="100%"
			>
				It’s time to move to the next stage Congratulations! Now you know how to work with Code Editor. Next time, we'll work with CSS FlexBox.
				<br />
				{"\n\n"}
			</Text>
			<LinkBox
