...
import { Theme, Text, Section, Box, Em, Image, Span, List, Icon, Button, LinkBox } from "@quarkly/widgets";
...
You can convert only one element, but that element can contain other elements.
					...
					>
						...
						>
							...
							<Image src="https://uploads.quarkly.io/6152385329a0a1001e6c901c/images/screen8.png?v=2021-09-29T21:22:30.653Z" border-radius="4px" margin="0px 0px 18px 0px" object-position="0px 0px" />
							<Text
								display="inline-block"
								font="normal 400 14px/1.5 --fontFamily-sans"
								margin="0px 0px 0px 0px"
