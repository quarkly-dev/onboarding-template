...
import { Theme, Text, Section, Box, Em, Image, Span, Icon, List, Button, Link, LinkBox } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="100px 0" sm-padding="40px 0" md-padding="60px 0 60px 0" quarkly-title="Step 1. Add Elements">
			...
			>
				...
				panel drag elements into the workspace.
			</Text>
				...
				>
					...
					>
						...
						<Box width="100%">
							...
							<Image width="100%" src="https://uploads.quarkly.io/6152385329a0a1001e6c901c/images/screen5.png?v=2021-09-28T10:19:39.895Z" border-radius="4px" />
						</Box>
					</Box>
					<Box
						width="auto"
 ...
 add elements to{"  "}
				...
				>
					...
					>
						...
						<Box width="100%">
							...
							<Text
								display="inline-block"
								font="normal 400 14px/1.7 --fontFamily-sans"
		...
		<Section
			...
			quarkly-title="Step 6. Center Align Elements"
			display="flex"
		>
			<Override slot="SectionContent" align-items="flex-start" />
			<Box position="relative" display="inline-block" margin="0px 0px 0px 21px" quarkly-title="Step">
				...
				>
					...
					>
						...
						<Box width="100%">
							...
							<Image src="https://uploads.quarkly.io/6152385329a0a1001e6c901c/images/screen2.png?v=2021-09-27T23:10:38.584Z" border-radius="4px" max-width="100%" />
						</Box>
					</Box>
					<Box
						width="auto"
					...
					>
						...
						<Box width="100%">
							...
							<Image
								src="https://uploads.quarkly.io/6152385329a0a1001e6c901c/images/screen3.png?v=2021-09-27T23:09:43.195Z"
								border-radius="4px"
					...
					>
						...
						<Box width="100%">
							...
							<Image src="https://uploads.quarkly.io/6152385329a0a1001e6c901c/images/screen4.png?v=2021-09-27T23:11:28.794Z" border-radius="4px" margin="0px 0px 24px 0px" max-width="100%" />
							<Text
								display="flex"
								font="normal 400 14px/1.5 --fontFamily-sans"
								margin="0px 0px 0px 0px"
