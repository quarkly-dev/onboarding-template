...
import { Theme, Text, Section, Box, Em, Image, Span, Icon, Link, List, Button, Strong, LinkBox } from "@quarkly/widgets";
					...
					>
						...
						<Box width="100%" display="flex" sm-flex-direction="column">
							<Text
								...
								sm-width="100%"
							>
								Grab the page border and drag it to the left. As the page width decreases, the example card will rebuild itself. This happens due to custom styles at breakpoints. Let's reproduce this behavior.
							</Text>
							<Image
